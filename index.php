	...
	<form class="form" name="formmaker" action="form.php" method="POST">
		<fieldset>
			...
			<div class="head">
				...
				<input type="color" name="bcolor" id="bcolor"></input><br><br>
				</div>
			</div>
			<div class="none"></div>
			<div class="tail">
				<div class="fields">
				Number of members: (max. 10)<input onkeyup="addFields()" onchange="addFields()" type="text" id="member" name="member"><br /><br />
					<div id="container"/>
